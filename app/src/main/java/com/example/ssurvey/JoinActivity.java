...
public class JoinActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.joinBtnJoin.setOnClickListener(v -> {
            ...
            // 모든 검사를 통과
                ...
                Toast.makeText(this, "회원 가입 중입니다.", Toast.LENGTH_LONG).show();
    ...
    public String setUserAndResultMsg() {
        ...
        String pw = binding.joinEtPw.getText().toString();
    ...
    public void onBackPressed() {
        if(binding.joinProgress.getVisibility() == View.GONE) {
            new AlertDialog.Builder(this).setTitle("회원 가입 중단").setMessage("작성하던 내용이 사라집니다. 회원 가입을 중단하시겠습니까?")
