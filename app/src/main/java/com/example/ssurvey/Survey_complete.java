...
public class Survey_complete extends MainActivity {
    ...
    private void displaySurveyStatistics(SurveyStatistics statistics) {
        ...
        participantCountSurveyComplete.setText(statistics.getTotalRespondents());

        q1ans1NumSurveyComplete.setText(statistics.getQ1ResponseCount(1)/statistics.getTotalRespondents()*100);
        q1ans2NumSurveyComplete.setText(statistics.getQ1ResponseCount(2)/statistics.getTotalRespondents()*100);
        q1ans3NumSurveyComplete.setText(statistics.getQ1ResponseCount(3)/statistics.getTotalRespondents()*100);
        q1ans4NumSurveyComplete.setText(statistics.getQ1ResponseCount(4)/statistics.getTotalRespondents()*100);
        q1ans5NumSurveyComplete.setText(statistics.getQ1ResponseCount(5)/statistics.getTotalRespondents()*100);

        q2ans1NumSurveyComplete.setText(statistics.getQ2ResponseCount(1)/statistics.getTotalRespondents()*100);
        q2ans2NumSurveyComplete.setText(statistics.getQ2ResponseCount(2)/statistics.getTotalRespondents()*100);
        q2ans3NumSurveyComplete.setText(statistics.getQ2ResponseCount(3)/statistics.getTotalRespondents()*100);
        q2ans4NumSurveyComplete.setText(statistics.getQ2ResponseCount(4)/statistics.getTotalRespondents()*100);
        q2ans5NumSurveyComplete.setText(statistics.getQ2ResponseCount(5)/statistics.getTotalRespondents()*100);

        q3ans1NumSurveyComplete.setText(statistics.getQ3ResponseCount(1)/statistics.getTotalRespondents()*100);
        q3ans2NumSurveyComplete.setText(statistics.getQ3ResponseCount(2)/statistics.getTotalRespondents()*100);
        q3ans3NumSurveyComplete.setText(statistics.getQ3ResponseCount(3)/statistics.getTotalRespondents()*100);
        q3ans4NumSurveyComplete.setText(statistics.getQ3ResponseCount(4)/statistics.getTotalRespondents()*100);
        q3ans5NumSurveyComplete.setText(statistics.getQ3ResponseCount(5)/statistics.getTotalRespondents()*100);
    }
